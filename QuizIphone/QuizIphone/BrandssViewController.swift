...
class BrandssViewController: UIViewController {
    ...
    @IBAction func btnSave(_ sender: Any) {
        ...
        nameTask.name_phone = etName.text//deklarasikan bahwa nameTask.name_task itu isinya dari etNametask.text
        
        nameTask.seri_brand = etSeries.text
        nameTask.name_brand = etBrand.text
